        ...
        <section class="rent_section layout_padding">
          <div class="container">
            <div class="rent_container">
              <div class="box">
                <div class="img-box">
                  <img src="https://www.lamborghini.com/sites/it-en/files/DAM/lamborghini/facelift_2019/model_detail/menu/09_09/menu_asterion.png" alt="">
                </div>
                <div class="price">

                 <p>fiat 500<span id="dots">...</span><span id="more"><br>
                 Prix: 200DH/Jour.<br>
                 Modele:2019.<br>
                 Kilometrage:20000km.
              ...
              <div class="box">
                <div class="img-box">
                  <img src="https://cdn2.hondacarindia.com/models/carModelImage/hondeCityEhev/eHEV-Desktop.png" alt="">
                </div>
                <div class="price">

                 <p>fiat 500<span id="dots1">...</span><span id="more1"><br>
                 Prix: 200DH/Jour.<br>
                 Modele:2019.<br>
                 Kilometrage:20000km.
                 ...
                 <button onclick="myFunction1()" id="myBtn1"><a>  Read more   </a></button>
                </div>
                <br>
              </div>
              <div class="box">
                <div class="img-box">
                  <img src="https://www.autotrader.co.uk/new-cars/images/static/Ford_Fiesta_Car.png" alt="">
                </div>
                <div class="price">

                 <p>fiat 500<span id="dots2">...</span><span id="more2"><br>
                 Prix: 200DH/Jour.<br>
                 Modele:2019.<br>
                 Kilometrage:20000km.
                 ...
                 <button onclick="myFunction2()" id="myBtn2"><a>  Read more   </a></button>
                </div>
              </div>
              <div class="box">
                <div class="img-box">
                ...
                <div class="price">
                 ...
                 <p>fiat 500<span id="dots3">...</span><span id="more3"><br>
                 Prix: 200DH/Jour.<br>
                 Modele:2019.<br>
                 Kilometrage:20000km.
                 ...
                 <button onclick="myFunction3()" id="myBtn3"><a>  Read more   </a></button>
                </div>
              </div>
              <div class="box">
                <div class="img-box">
                  <img src="https://freepngimg.com/thumb/car/4-2-car-png-hd.png" alt="">
                </div>
                <div class="price">

                 <p>bmw<span id="dots4">...</span><span id="more4"><br>
                 Prix: 400DH/Jour.<br>
                 Modele:2018.<br>
                 Kilometrage:40000km.
                 ...
                 <button onclick="myFunction4()" id="myBtn4"><a>  Read more   </a></button>
                </div>
              </div>
              <div class="box">
                <div class="img-box">
                  <img src="https://png.pngtree.com/png-clipart/20180613/ourmid/pngtree-fashion-car-private-car-orange-red-car-simulation-illustration-png-image_4484916.png" alt="">
                </div>
                <div class="price">

                 <p>fiat 500<span id="dots0">...</span><span id="more0"><br>
                 Prix: 200DH/Jour.<br>
                 Modele:2019.<br>
                 Kilometrage:20000km.
                 ...
                 <button onclick="myFunction0()" id="myBtn0"><a>  Read more   </a></button>
                </div>
                <br>
              </div>
            </div>
