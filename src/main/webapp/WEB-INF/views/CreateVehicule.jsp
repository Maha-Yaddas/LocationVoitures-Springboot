...
border:none;
   ...
   <div class="row" id="body-row">
       ...
       <!-- MAIN -->
       <div class="col p-4">
           <h1 class="display-4">Vehicule Creation</h1>
           <div class="card">
            <center>   <h5 class="card-header font-weight-light"> ${message}</h5></center>
			    		...
			    		<form role="form"   action="saveVehicule" method="post" >
			    			<div class="row">
			    			<br>
			    				<div class="col-xs-6 col-sm-6 col-md-6">
                            			    					<div class="form-group"><br>
                            			    						   <input type="text" id="matricule" name="matricule" class="form-control input-sm" placeholder="matricule">
                            			    					</div>
                            			    				</div>
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
<br>
			                 <input type="text" id="marque" name="marque" class="form-control input-sm" placeholder="marque">
			    					</div>
			    				</div>
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
			    						  <input type="text" id="modele" name="modele" class="form-control input-sm" placeholder="modele">
			    					</div>
			    				</div>
			    				<div class="col-xs-6 col-sm-6 col-md-6">
                                			    					<div class="form-group">
                                			    						 <input type="text" id="prix" name="prix" class="form-control input-sm" placeholder="prix">
                                			    					</div>
...
<br>
			    			 ...
			    			 <input type="submit" class="add" value="AJOUTER" class="btn btn-info btn-block"/><br>
