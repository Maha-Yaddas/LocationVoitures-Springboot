...
<html lang="en">
    <head>
        ...
        <title>Vehicule Modification</title>
        <style>
        body{
...
border:none;
   ...
   <div class="row" id="body-row">
       ...
       <!-- MAIN -->
       <div class="col p-4">
           <h1 class="display-4">Vehicule Modification </h1>
           <div class="card">
            <center>   <h5 class="card-header font-weight-light"> ${message}</h5></center>
			    		...
			    		<form role="form" action="updateVehicule" method="post" >
                        			    			<div class="row">
                        			    			<br>
                        <input type="hidden" name="idVehicule" value="${vehicules.idVehicule}" />
                        			    				<div class="col-xs-6 col-sm-6 col-md-6">
                                                    			    					<div class="form-group"><br>
                                                    			    						   <input type="text" id="matricule" value="${vehicules.matricule}" name="matricule" class="form-control input-sm" >
                                                    			    					</div>
                                                    			    				</div>
                        			    				<div class="col-xs-6 col-sm-6 col-md-6">
                        			    					<div class="form-group">
                        <br>
                        			                 <input type="text" id="marque" name="marque" value="${vehicules.marque}" class="form-control input-sm" >
                        			    					</div>
                        			    				</div>
                        			    				<div class="col-xs-6 col-sm-6 col-md-6">
                        			    					<div class="form-group">
                        			    						  <input type="text" id="modele" name="modele" value="${vehicules.modele}" class="form-control input-sm" >
                        			    					</div>
                        			    				</div>
                        			    				<div class="col-xs-6 col-sm-6 col-md-6">
                                                        			    					<div class="form-group">
                                                        			    						 <input type="text" id="prix" value="${vehicules.prix}" name="prix" class="form-control input-sm" >
                                                        			    					</div>
                        ...
                        <br>
                        			    			 ...
                        			    			 <input type="submit" class="add" value="update"  class="btn btn-info btn-block"/><br>


                        </div>
                        <center><a href="/getAllVehicules">Cars List</a></center><br>
                        			    		</form>
