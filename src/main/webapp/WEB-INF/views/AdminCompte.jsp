...
.custab:hover{
   ...
   <div class="row" id="body-row">
       ...
       <!-- MAIN -->
       <div class="col p-4">
           <h1 class="display-4">Profile Admin </h1>
           <div class="card">
...
<div class="container" style="center">
  ...
  <center>  <table class="table table-striped custab" ><br>
    ...
    <c:forEach var="admn" items="${admin}">
    <tr>
                <center>  <td class="text-center">${admn.username}</td></center>
                        <center>      <td class="text-center">${admn.password}</td></center>
                       <center>      <td class="text-center"><a href="showAdmin?id=${admn.idAdmin}" class='btn btn-info btn-xs'>Edit</a></td></center>
