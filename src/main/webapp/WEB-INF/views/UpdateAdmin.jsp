...
border:none;
   ...
   <div class="row" id="body-row">
       ...
       <!-- MAIN -->
       <div class="col p-4">
           <h1 class="display-4">Admin Modification </h1>
           <div class="card">
                        ...
                        <input type="hidden" name="idAdmin" value="${admin.idAdmin}" />
			    			<div class="row">
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					...
			    					<input type="text" id="login" name="username"  value="${admin.username}" class="form-control input-sm" >
			    					</div>
			    				</div>

	<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
			    						   <input type="password" id="password" name="password" value="${admin.password}"  class="form-control input-sm" >
			    					</div>
			    				</div>
