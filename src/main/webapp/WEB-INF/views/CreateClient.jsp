       ...
       <div class="col p-4">
           ...
           <div class="card">
            <center>   <h5 class="card-header font-weight-light"> ${message}</h5></center>
			    		...
			    		<form role="form"   action="saveClient" method="post" >
			    			<div class="row">
			    			<br>
			    				<div class="col-xs-6 col-sm-6 col-md-6">
                            			    					<div class="form-group"><br>
                            			    						   <input type="text" id="cin" name="cin" class="form-control input-sm" placeholder="cin">
                            			    					</div>
                            			    				</div>
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
<br>
			                <input type="text" id="nom" name="nom" class="form-control input-sm" placeholder="nom">
			    					</div>
			    				</div>
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
			    						  <input type="text" id="prenom" name="prenom" class="form-control input-sm" placeholder="prenom">
			    					</div>
			    				</div>
			    				<div class="col-xs-6 col-sm-6 col-md-6">
                                			    					<div class="form-group">
                                			    						 <input type="text" id="adresse" name="adresse" class="form-control input-sm" placeholder="adresse">
                                			    					</div>
                                			    				</div>
			    			</div>
...
<div class="row">
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
			    					 <input type="text" id="tel" name="tel" class="form-control input-sm" placeholder="TEL">
			    					</div>
			    				</div>
	...
	<div class="col-xs-6 col-sm-6 col-md-6">
			    					...
			    					<div class="col-xs-6 col-sm-6 col-md-6">
                                			    					<div class="form-group">
                                                                    			    					<input type="submit" class="add" value="AJOUTER" class="btn btn-info btn-block">
                                                                    			    					</div>
                                			    				</div>
<br>
