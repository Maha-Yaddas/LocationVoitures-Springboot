...
.custab:hover{
   ...
   <div class="row" id="body-row">
       ...
       <!-- MAIN -->
       <div class="col p-4">
           <h1 class="display-4">Vehicules List </h1>
           <div class="card">
...
<div class="container" style="center">
  ...
  <center>  <table class="table table-striped custab" ><br>
    <thead >
    <a href="/createVehicule"  class="btn btn-primary btn-xs pull-right"><b>+</b> Add new Vehicule</a><br>
        <tr>
            <tr>
                       <th>Id </th>
                                  <th>matricule</th>
    ...
    <tr>
                   ...
                   <td><img src="${vehicule.matricule}" width="75" height="75"></td>
                    <td>${vehicule.marque}</td>
                    <td>${vehicule.modele}</td>
                    <td>${vehicule.prix}</td>
                    <td><a href="deleteVehicule?id=${vehicule.idVehicule}" class="btn btn-danger btn-xs"
                             onClick="return confirm('Are you sure to delete this item?')" >Delete</a></td>
                    <td><a href="showVehicule?id=${vehicule.idVehicule}" class='btn btn-info btn-xs'>Edit</a></td>
