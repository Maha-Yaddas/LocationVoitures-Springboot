...
border:none;
   ...
   <div class="row" id="body-row">
       ...
       <!-- MAIN -->
       <div class="col p-4">
           <h1 class="display-4">create Reservation </h1>
           <div class="card">
            <center>   <h5 class="card-header font-weight-light"> ${message}</h5></center>
			    		...
			    		<form role="form" action="saveReservation" method="post" >
			    			<div class="row">
			    			<br>
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
<br><select id="vehicule" name="vehicule" class="form-control input-sm" >
                        ...
                        <option value="${vehicule.idVehicule}">${vehicule.marque}</option>
			    			...
			    			<fmt:formatDate pattern="yyyy-MM-dd" value="${reservation.dateReserv}" var="formatDateReserv"/>
                                                <input type="date" id="dateReserv" name="dateReserv" value="${formatDateReserv}" class="form-control input-sm" placeholder="dateLocation">
			    			</div>
			    				...
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
			    					 <fmt:formatDate pattern="yyyy-MM-dd" value="${reservation.datePrise}" var="formatDatePrise"/>
			    						<input type="date" id="datePrise" name="datePrise" value="${formatDatePrise}" class="form-control input-sm" placeholder="dateFin">
			    					</div>
			    				</div>
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
			    					<fmt:formatDate pattern="yyyy-MM-dd" value="${reservation.dateRetour}" var="formatDateRetour"/>
                                                       <input type="date" id="dateRetour" name="dateRetour" value="${formatDateRetour}" class="form-control input-sm" value="${formatDateReserv}">
...
<br>
			    			 ...
			    			 <input type="submit" class="add" value="add" class="btn btn-info btn-block">
