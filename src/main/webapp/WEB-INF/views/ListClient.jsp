...
<div class="container" style="center">
  ...
  <center>  <table class="table table-striped custab" ><br>
    <thead >
    <a href="/createClient" class="btn btn-primary btn-xs pull-right"><b>+</b> Add new client</a>
        <tr>
            <tr>
                       <th>Id </th>
                                 <th>Cin </th>
    ...
    <tr>
                            ...
                            <td>${client.idClient}</td>
                             ...
                             <td><a href="deleteClient?id=${client.idClient}" class="btn btn-danger btn-xs"
                             onClick="return confirm('Are you sure to delete this item?')" >Delete</a></td>
                             <td><a href="showClient?id=${client.idClient}" class='btn btn-info btn-xs'>Edit</a></td>
